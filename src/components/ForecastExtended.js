...
class ForecastExtended extends Component {
    ...
    updateCity = city => {
        const url_forecast = `${ apiEndpoint }?q=${ city }&APPID=${ apiKey }`;
    ...
    renderProgress = () => { return ( <div><LinearProgress></LinearProgress></div> )}
    ...
    render () { 
        ...
        return(
            <div>
                <h3 className='forecast-title'>Extended forecast for {city}.</h3>
